# Effectum Asesores — Web 3.0

Sitio estático sin framework ni dependencias de ejecución, construido con HTML, CSS y JavaScript nativo.

## Estructura

- `index.html`: arquitectura comercial, contenido, SEO y datos estructurados.
- `styles.css`: sistema visual, fuentes locales, responsive, accesibilidad y movimiento.
- `script.js`: menú móvil, animaciones progresivas e instrumentación de eventos.
- `public/effectum-logo.png`: activo maestro del logotipo oficial.
